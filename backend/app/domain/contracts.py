...
class Contract:
    ...
    def accept(self, now: datetime, deadline_seconds: int | None) -> None:
        ...
        self.state = ContractState.ACTIVE; self.accepted_at = now
        self.deadline_at = now + __import__("datetime").timedelta(seconds=deadline_seconds) if deadline_seconds else None
