...
class UnitOfWork(AbstractContextManager["UnitOfWork"],Protocol):
    wallets:WalletRepository; inventories:InventoryRepository; jobs:JobRepository; characters:CharacterRepository; vehicles:VehicleRepository; contracts:ContractRepository; idempotency:IdempotencyRepository; audit:AuditRepository; outbox:OutboxRepository
