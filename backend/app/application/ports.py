...
class UnitOfWork(AbstractContextManager["UnitOfWork"],Protocol):
    wallets:WalletRepository; inventories:InventoryRepository; jobs:JobRepository; characters:CharacterRepository; vehicles:VehicleRepository; settlements:SettlementRepository; contracts:ContractRepository; idempotency:IdempotencyRepository; audit:AuditRepository; outbox:OutboxRepository
