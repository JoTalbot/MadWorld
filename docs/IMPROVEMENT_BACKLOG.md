...
- Goal: introduce persistent contracts as the mission/economic backbone connecting gathering, crafting, market activity and expeditions, with deterministic progression and extensibility for factions and dynamic objectives.
- Variants considered:
  1. Minimal: simple one-off contracts with objectives and rewards.
  2. Systemic: persistent contract entities, lifecycle states, deadlines, requirements, objectives and authoritative rewards.
